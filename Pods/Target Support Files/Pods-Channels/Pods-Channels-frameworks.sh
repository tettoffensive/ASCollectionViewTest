...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'Pods-Channels/AsyncDisplayKit.framework'
  install_framework 'Pods-Channels/Bolts.framework'
  install_framework 'Pods-Channels/DateTools.framework'
  install_framework 'Pods-Channels/FBSDKCoreKit.framework'
  install_framework 'Pods-Channels/FBSDKLoginKit.framework'
  install_framework 'Pods-Channels/FBSDKShareKit.framework'
  install_framework 'Pods-Channels/FLKAutoLayout.framework'
  install_framework 'Pods-Channels/FXBlurView.framework'
